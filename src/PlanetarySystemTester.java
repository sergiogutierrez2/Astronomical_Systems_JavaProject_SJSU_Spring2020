/**
 * Test Class for Planetary Systems.
 */
public class PlanetarySystemTester {
    /**
     * Test main method for Planetary Systems.
     * @param args
     */
    public static void main(String[] args)
    {
        ...
        System.out.println("Where is Planet Terra Rotating Around? ");
        lylatSystem.get(1).rotate();

        System.out.println("Where is Star Orion Rotating Around? ");
        lylatSystem.get(0).rotate();
    }
}